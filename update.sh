...
function create_user() {
	...
	wget -qO /tmp/client.ovpn "http://sshaiopremium.ga/script/debian7/1194-client.ovpn"
	...
	echo "========================="
	echo "Script by Orang Kuat Sabahan Terkini, gunakan akun dengan bijak"
	echo "========================="
}
...
function used_data(){
	...
	echo -e "\e[031;1m 1\e[0m) Buat Akun SSH/OpenVPN (\e[31;1muser-add\e[0m)"
	echo -e "\e[031;1m 2\e[0m) Generate Akun SSH/OpenVPN (\e[31;1muser-gen\e[0m)"
	echo -e "\e[031;1m 3\e[0m) Generate Akun Trial (\e[34;1muser-trial\e[0m)"
	echo -e "\e[031;1m 4\e[0m) Ganti Password Akun SSH/VPN (\e[31:1muser-pass\e[0m)"
	...
	case $option1 in
	    ...
	    25)
            ...
            ./speedtest.py --share
            echo "Hasil Speed tes diatas Script by Ibnu Fachrizal"
            echo""
            ;;
        26)
            free -m
        ...
        30)	
            ...
            service openvpn restart
            echo "Restart OpenVPN selesai Script By Ibnu Fachrizal"
            echo""
			;;	
		31)
            clear
            ...
            service dropbear restart
            echo "Restart Dropbear selesai Script By Ibnu Fachrizal"
            echo""
            ;;
		32) 
		    clear
		...
		33)
		    ...
		    echo "Restart Webmin selesai Script By Ibnu Fachrizal"
		    echo""
		    ;;
		34)
		    clear
